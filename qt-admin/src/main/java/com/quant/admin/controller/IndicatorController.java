...
public class IndicatorController extends BaseController {
    ...
    public ApiResult backTest(@RequestBody BuyAndSellIndicatorTo to) {
        ...
        for (int i = 0; i < series.getEndIndex(); i++) {
            ...
            if (strategy.shouldEnter(endIndex)) {
                ...
                if (entered) {
                    ...
                    System.out.println(
                            "Entered on " + entryOrder.getIndex() + " (price=" + entryOrder.getPricePerAsset()
                                    .doubleValue() + ", amount=" + entryOrder.getAmount().doubleValue() + ")");
                }
                ...
                if (exited) {
                    ...
                    System.out.println("Exited on " + exitOrder.getIndex() + " (price=" + exitOrder.getPricePerAsset()
                            .doubleValue() + ", amount=" + exitOrder.getAmount().doubleValue() + ")");
                }
        ...
        // Analysis
        System.out.println("策略总收益: " + new TotalProfitCriterion().calculate(series, tr));

        System.out.println("策略总交易数: " + tr.getTradeCount());
