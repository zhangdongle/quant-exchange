 ...
 */
@Slf4j
public class HuobiDefaultBuyPriceHandle extends StrategyHandle {


    public HuobiDefaultBuyPriceHandle(StrategyHandle handle) {
        super(handle);
    }
    ...
    public HandleResult strategyRequest(TradingApi tradingApi, MarketConfig marketConfig, StrategyConfig config,
        ...
        if (baseInfo.getIsAllBuy() == SellType.sellAll.getType()) {
