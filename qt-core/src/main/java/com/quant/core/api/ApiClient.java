...
public class ApiClient {
    ...
    public Long createOrder(CreateOrderRequest request) {
        ApiResponse<Long> resp = post("/v1/order/orders/place", request, new TypeReference<ApiResponse<Long>>() {
        });
        return resp.checkAndReturn();
    }
    ...
    public ApiResponse<List<OrdersDetail>> openOrders(String accountId, String symbol, String side, String size) {
        ...
        map.put("size", size);
        ApiResponse<List<OrdersDetail>> response = get("/v1/order/openOrders", map,
                new TypeReference<ApiResponse<List<OrdersDetail>>>() {
                });
        return response;
    }
    ...
    public HistoryTradeResponse historyTrade(String symbol, String size) {
        ...
        map.put("symbol", symbol);
        map.put("size", size);
        HistoryTradeResponse resp = get("/market/history/trade", map,
                new TypeReference<HistoryTradeResponse<List<Trade<List<TradeBean>>>>>() {
                });
        return resp;
    }
    ...
    public AccountsResponse accounts() {
        AccountsResponse resp = get("/v1/account/accounts", null,
                new TypeReference<AccountsResponse<List<Accounts>>>() {
                });
        return resp;
    }
    ...
    public BalanceResponse balance(String accountId) {
        BalanceResponse resp = get("/v1/account/accounts/" + accountId + "/balance", null,
                new TypeReference<BalanceResponse<Balance<List<BalanceBean>>>>() {
                });
        return resp;
    }
    ...
    public BatchcancelResponse submitcancels(List orderList) {
        BatchcancelResponse resp = post("/v1/order/orders/batchcancel", orderList,
                new TypeReference<BatchcancelResponse<Batchcancel<List, BatchcancelBean>>>() {
                });
        return resp;
    }
    ...
    public OrdersDetailResponse ordersDetail(String orderId) {
        OrdersDetailResponse resp = get("/v1/order/orders/" + orderId, null,
                new TypeReference<OrdersDetailResponse<OrdersDetail>>() {
                });
        return resp;
    }
    ...
    public MatchresultsOrdersDetailResponse matchresults(String orderId) {
        MatchresultsOrdersDetailResponse resp = get("/v1/order/orders/" + orderId + "/matchresults", null,
    ...
    public IntrustDetailResponse intrustOrdersDetail(IntrustOrdersDetailRequest req) {
        ...
        IntrustDetailResponse resp = get("/v1/order/orders/", map,
